        ...
        <tbody className="divide-y divide-slate-800/40">
          {sortedTeams.map((team, idx) => (
            <React.Fragment key={team.id}>
              ...
              {idx === 3 && idx < sortedTeams.length - 1 && (
                <tr key="threshold">
                  <td colSpan={10} className="px-4 py-1">
                    <div className="flex items-center gap-2">
                      <div className="h-[1px] flex-1 bg-yellow-500/20" />
                      <span className="text-[8px] font-black text-yellow-500/40 uppercase tracking-widest whitespace-nowrap">Playoff Qualification Threshold</span>
                      <div className="h-[1px] flex-1 bg-yellow-500/20" />
                    </div>
                  </td>
                </tr>
